...
> Status: REFERENCE
> Purpose: docs와 skills의 역할 분리 원칙을 설명하는 운영 전략 문서다.
> Source Of Truth: `../../../docs/00_CANONICAL/`, `../README.md`
> Depends On: `./16_AI_Friendly_Skill_Ready_Documentation_Architecture.md`
> Used By: `../../../docs/09_SOURCE_INPUTS/02_ENGINEERING/CODING_CONVENTION.md`, `../../../backend/CODING_CONVENTION.md`, skill refactoring, workflow design
